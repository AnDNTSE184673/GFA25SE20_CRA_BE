...
namespace Repository.Migrations
{
    ...
    [Migration("20260106141053_CarToll_CarTollTransac_CarWallet")]
    partial class CarToll_CarTollTransac_CarWallet
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repository.Data.Entities.DriverLicense", b =>
                {
                    ...
                    b.Property<DateOnly?>("LicenseDoB")
                        .HasColumnType("date");

                    b.Property<DateOnly?>("LicenseExpiry")
                        .HasColumnType("date");

                    b.Property<DateOnly?>("LicenseIssue")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("Repository.Data.Entities.Inquiry", b =>
                {
                    ...
                    b.Property<Guid?>("ParentInquiryId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Repository.Data.Entities.InquiryImages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Repository.Data.Entities.Report", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Repository.Data.Entities.ReportImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Repository.Data.Entities.Inquiry", b =>
                {
                    b.HasOne("Repository.Data.Entities.Inquiry", "ParentInquiry")
                        .WithMany("Replies")
                        .HasForeignKey("ParentInquiryId");
            ...
            modelBuilder.Entity("Repository.Data.Entities.InquiryImages", b =>
                {
                    b.HasOne("Repository.Data.Entities.Inquiry", "Inquiry")
                        .WithMany("InquiryImages")
            ...
            modelBuilder.Entity("Repository.Data.Entities.ReportImage", b =>
                {
                    b.HasOne("Repository.Data.Entities.Report", "Report")
                        .WithMany("Images")
